...
![MSE of decompressed signal vs original ater PCA/SVD](MSE_Vs_U.png)
...
![kmeansclustering on samples](k_means_input.png)
...
boundaries in general, do actually signify distinct and brain activity. This potential is hard to investigate and needs to be done by association of cluster activity to the rodents's behavior. That being said, being able to come up with the same results as the current methods is a good first step.
